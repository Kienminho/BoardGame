...
const createResponseModel = (code, message, data = null, totalRecord = 0) => {
  return {
    statusCode: code,
    message: message,
...
const createSuccessResponseModel = (data = true, totalRecord = 1) => {
  return {
    statusCode: 200,
    message: "Successful",
    totalRecord: totalRecord,
...
const createErrorResponseModel = (data = false, message = "Error!") => {
  return {
    statusCode: 400,
    message: message,
    totalRecord: 0,
